          ...
          p = (function (e) {
            ...
            return (
              ...
              (t.prototype.start = function () {
                ...
                1 != e &&
                  ((this.bencichengji.getComponent(cc.Sprite).spriteFrame =
                    this.bencichengjiarr[e - 1]),
                  (this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame =
                    this.gengduoyouxiarr[e - 1])),
          ...
          m = (function (e) {
            ...
            return (
              ...
              (t.prototype.createOneFruit = function (e) {
                ...
                // 让说过更 Q 弹
                if (fruitQTan) {
                  n.getComponent(cc.PhysicsCircleCollider).restitution =
                    fruitQTan;
                }
        ...
        var o = {
              ...
              t
                ? ((e = e.split(".")[0]),
                  (n.addComponent(cc.Sprite).spriteFrame =
                    GameTools.love2048FrameCache.getSpriteFrame(e)))
          ...
          setNodeSpriteFrame: function (e, t) {
            e.getComponent(cc.Sprite).spriteFrame =
              GameTools.love2048FrameCache.getSpriteFrame(t);
          },
            ...
            return (
              ...
              (t.prototype.onTouchMove = function (e) {
                i.default.playerTouch &&
                  null != a.default.Instance.targetFruit &&
                  ((this.touchNum = 1),
                  (a.default.Instance.targetFruit.x =
                    this.node.convertToNodeSpaceAR(e.getLocation()).x));
              }),
                  ...
                  this.scheduleOnce(function () {
                    if (setFruits) {
                      ...
                      i.default.GameUpdateCtrl &&
                        (startFruits.length > t.createFruitCount
                          ? (a.default.Instance.createOneFruit(
                              startFruits[t.createFruitCount]
                            ),
                            t.createFruitCount++)
                          : (a.default.Instance.createOneFruit(
                              setFruits.randomFunction()
                            ),
                            t.createFruitCount++));
                    } else {
                      i.default.GameUpdateCtrl &&
              ...
              (t.prototype.addScore = function () {
                ...
                (e.position = cc.v2(0, 200)),
                  (e.scale = 0),
                  (e.opacity = 255),
                  (e.children[1].getComponent(cc.Label).string =
                    this.comboNumber.toString()),
                  e.runAction(
                    cc.sequence(
            ...
            return (
              ...
              (t.prototype.createSuipian = function () {
                ...
                (e.position = cc.v2(0, 0)),
                  (e.scale =
                    cc.find("Canvas/baziNodeU").children[0].children[0].scale);
              }),
            ...
            return (
              ...
              (t.prototype.update = function (e) {
                this.UpdateScoreLabel(e),
                  ...
                  (this.levelPanel.children[1].getComponent(cc.Label).string =
              ...
              (t.prototype.adsButtonFunc = function () {
                if (clickChangeFruit) {
                  if (gameFunction.default.Instance.targetFruit) {
                    ...
                    gameFunction.default.Instance.createOneFruit(
          ...
          s = (function (e) {
            ...
            return (
              ...
              (t.prototype.scheduleWater = function () {
                this.waterParent.children[this._waterGenrateCount++].active =
                  !0;
              }),
        ...
        var o = {
          ...
          newSprite: function (e) {
            if (null != this.SpriteFrameJs.getSpriteFrame(e)) {
              var t = new cc.Node();
              return (
                (t.addComponent(cc.Sprite).spriteFrame =
                  this.SpriteFrameJs.getSpriteFrame(e)),
                t
              );
            }
            return null;
          ...
          setTexture: function (e, t) {
            e.getComponent(cc.Sprite).spriteFrame =
              this.SpriteFrameJs.getSpriteFrame(t);
          },
            ...
            return (
              ...
              (t.prototype.onBeginContact = function (e, t, n) {
                ...
                if (
                  ...
                  (t.node.parent = cc.find("Canvas/fruitNode")),
                    (i.default.Instance.fruitHeigth =
                      i.default.Instance.findHighestFruit()),
                  ...
                  (reverseLevelUp
                    ...
                    ? ((this.pengzhuangCount += 1),
                      0 == t.node.getComponent("fruitData").getNumber() &&
                        ((a.default.score +=
                          this.fruitNumber + (extraScore ? extraScore : 1)), // 改分数
          ...
          u = (function (e) {
            ...
            return (
              ...
              (t.prototype.initTitle = function () {
                ...
                1 != e &&
                  (this.titleSpr.getComponent(cc.Sprite).spriteFrame =
                    this.title[e - 1]),
                  this.initTitleAni();
              }),
